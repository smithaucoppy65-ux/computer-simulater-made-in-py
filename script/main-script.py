...
while True:
    ...
    if choice == "1":
       ...
       print(cookie)
         ...
         print("please wait...")
         time.sleep(9.9)
         print(r" /localsever/id:945589/port:9963/localhost/authidentification/tru/code:********/redirect=...")
         time.sleep(9.9)
         print(r" /cloud/sever/identification:sesusfall/redirect=...")
         time.sleep(9.9)
         print(r" severs/e445d55f48jgy4t/id=9585/redirect=...")
         time.sleep(9.9)
         print(r" id=9585/sever/conect/locate/redirect=...")
         time.sleep(9.9)
         print(r" auth/id/secsesfull/redirect=...")
         time.sleep(9.9)
         print(r" localpc:81265/id:9585/file:")
         print(r" %USERPROFILE%/Desktop/computer simulater/options/8/option_8.exe")
         time.sleep(9.9)
